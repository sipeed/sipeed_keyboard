...
#define USB_CONFIG_SIZE (9 + CDC_ACM_DESCRIPTOR_LEN + HID_KEYBOARD_DESCRIPTOR_LEN +HID_DATA_DESCRIPTOR_LEN)
...
void usb_init(){ //task init
    ...
    if (usb_fs) {
        device_control(usb_fs, DEVICE_CTRL_SET_INT, (void *)(USB_EP1_DATA_IN_IT |USB_EP2_DATA_OUT_IT | USB_EP3_DATA_OUT_IT | USB_EP5_DATA_IN_IT| USB_EP6_DATA_IN_IT));
    }
